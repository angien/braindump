    ...
    <div class="container theme-showcase spacingfix2" role="main">
      <div class="jumbotron">
        ...
        <form action="<?php $PHP_SELF?>" method="post" onsubmit="return finalValidate(['name', 'email', 'pass'])">
              <h3><span class="label label-info">Name:</span></h3> 
          <p><input type="text" name ="name" onkeyup="validate(this.name, this.value)" />
          <input type="checkbox" name="name" disabled></p><small><span name="name"></span></small>
          ...
          <input type="submit" class="btn btn-lg btn-default" name="submit" value="Register">
        </form>
<br>
        ...
        if(isset($_POST["submit"])) {
          ...
          if ($result) {
            ...
            echo 'Your E-mail has already been registered!';
